...
export function Environment(name: string): BaseURL {
    return `https://${name}-mc-uptime-api-ggui.encr.app`
}
...
/**
 * Client is an API client for the mc-uptime-api-ggui Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "mc-uptime-api-ggui-Generated-TS-Client (Encore/v1.46.4)";
        }
